...
```sh
git clone --branch v0.5.1 --depth 1 https://github.com/KOBIL-GmbH/kobil-sdk-integration.git /absolute/path/kobil-sdk/releases/v0.5.1
cd /absolute/path/kobil-sdk/releases/v0.5.1
...
```json
{
  "servers": {
    "KOBILSDK": {
      ...
      "args": ["run", "--frozen", "--directory", "/absolute/path/kobil-sdk/releases/v0.5.1", "kobil-sdk-mcp"],
      "env": {
...
`/absolute/path/kobil-sdk/releases/v0.5.1/skills/kobil-sdk/SKILL.md`.
