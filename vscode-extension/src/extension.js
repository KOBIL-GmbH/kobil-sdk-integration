...
function activate(context){
 ...
 async function install(){
  ...
  // Validate existing checkouts before uv can execute project build configuration.
  await verifyCheckout();
