...
class StarterTests(unittest.TestCase):
    ...
    def test_mcp_tools_registered(self):
        ...
        self.assertTrue(names >= {"sdk_sftp_list", "sdk_sftp_download", "sdk_targets", "sdk_plan", "sdk_artifact_info", "sdk_backend_status", "sdk_app_get", "sdk_app_versions", "sdk_app_ensure", "sdk_app_version_ensure", "sdk_config_write", "sdk_tms_trigger", "sdk_tms_status", "sdk_tms_result", "sdk_tms_cancel",
